...
public class ModItems {
    ...
    public static final List<RegistryObject<Item>> SPHERES = List.of(SAPPHIRE_SPHERE,SMOKESTONE_SPHERE,RUBY_SPHERE,DIAMOND_SPHERE,EMERALD_SPHERE,GARNET_SPHERE,ZIRCON_SPHERE,AMETHYST_SPHERE,TOPAZ_SPHERE,HELIODOR_SPHERE);
...
//            () -> new Item(new Item.Properties()));
    ...
    public static final List<RegistryObject<Item>> GEMSTONES = List.of(SAPPHIRE_GEMSTONE,SMOKESTONE_GEMSTONE,RUBY_GEMSTONE,GARNET_GEMSTONE,ZIRCON_GEMSTONE,TOPAZ_GEMSTONE,HELIODOR_GEMSTONE);
