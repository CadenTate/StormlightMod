...
public class ModArmorMaterials {
    public static final RegistryEntry<ArmorMaterial> GODMETAL_ARMOR_MATERIAL = registerArmorMaterial(
            "god_metal",
            () -> new ArmorMaterial(
                    ...
                    () -> Ingredient.ofItems(ModItems.WINE),
                    List.of(new ArmorMaterial.Layer(Identifier.of(StormlightMod.MOD_ID, "god_metal"))), 0, 0));
